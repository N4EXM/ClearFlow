...
const TaskCard = ({title, description}) => {
  return (
    <div
        className='w-full h-full bg-BGS rounded-md px-4 py-4 pt-3 flex flex-col justify-between'
    >
        ...
        >
            ...
            <textarea 
                ...
                className='w-56 h-full min-h-12 resize-none no-scrollbar outline-none text-xs font-medium placeholder:text-DText'
                maxLength={130}
            ></textarea>
        </div>
