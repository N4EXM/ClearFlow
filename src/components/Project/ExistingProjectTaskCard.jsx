...
const ExistingProjectTaskCard = ({id, title, description, date, formattedDate, completed, projectId, projectName, deleteFunction, updateFunction, maxDate}) => {
    ...
    const handleToggle = async () => {   
        updateFunction(id, newTitle, newDescription, newDate, !isCompleted, projectId, projectName)
    ...
    const handleUpdate = async () => {
        ...
        updateFunction(id, newTitle, newDescription, newDate, completed, projectId, projectName)
        setIsEdit(false)
    ...
    >
        ...
        >
            ...
            >                
                ...
                <input 
                    type="date" 
                    className='font-medium text-xs text-DText w-28 outline-none'  
                    value={newDate}
...
export default ExistingProjectTaskCard
